  ...
  body: [
    ...
    { type: 'h2', text: `IV. The Nine Laws of Mass Drift (Propositions)` },
    {
      ...
      items: [
        ...
        { term: 'Emotional Leverage', text: 'The rate of collective belief acceptance is a function of the emotional valance of the narrative, where narratives leveraging high-arousal emotions (fear, disgust, moral outrage) consistently outpace those based on rational, complex data.' },
